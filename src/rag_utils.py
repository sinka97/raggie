...
def embed_and_store_document(chromadb_ip,doc,collection_name,embed_fn):
...
def load_document(chromadb_ip, collection_name, embed_fn):
    # Instantiate connection to client
    client = chromadb.HttpClient( 
        host=chromadb_ip, 
        port=8000, 
...
def load_excel(excel_file,sheet_name):
